...
public class MiniMaxPlayer implements Player {
    ...
    public Command play(List<Command> nextMoves) {
        ...
        // do something with the next moves: nextMoves.get();
        System.out.print("Next move chosen by algorithm: " + nextMove);
        return nextMove;
    }
    ...
    public final int SEARCH_DEPTH = 5;
	
	private String bestMove = "";
	
	private int nodesTraversed = 0;
	private int stringsTraversed = 0;
	private int turns = 0;
	
	private long averageTime = 0;

	private int minimax(Board board, Player p1, Player p2, int depth, int maxDepth, int alpha, int beta)
	{
